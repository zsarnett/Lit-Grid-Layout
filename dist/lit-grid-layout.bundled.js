 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */;function O(t){let e=M.get(t.type);void 0===e&&(e={stringsArray:new WeakMap,keyString:new Map},M.set(t.type,e));let s=e.stringsArray.get(t.strings);if(void 0!==s)return s;const r=t.strings.join(i);return s=e.keyString.get(r),void 0===s&&(s=new o(t,t.getTemplateElement()),e.keyString.set(r,s)),e.stringsArray.set(t.strings,s),s}const M=new Map,$=new WeakMap;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */"undefined"!=typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.2.1");const Y=(t,...e)=>new S(t,e,"html",U)
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
...
(window.litElementVersions||(window.litElementVersions=[])).push("2.3.1");const tt={};class et extends F{static getStyles(){return this.styles}static _getUniqueStyles(){if(this.hasOwnProperty(JSCompiler_renameProperty("_styles",this)))return;const t=this.getStyles();if(void 0===t)this._styles=[];else if(Array.isArray(t)){const e=(t,s)=>t.reduceRight((t,s)=>Array.isArray(s)?e(s,t):(t.add(s),t),s),s=e(t,new Set),i=[];s.forEach(t=>i.unshift(t)),this._styles=i}else this._styles=[t]}initialize(){super.initialize(),this.constructor._getUniqueStyles(),this.renderRoot=this.createRenderRoot(),window.ShadowRoot&&this.renderRoot instanceof window.ShadowRoot&&this.adoptStyles()}createRenderRoot(){return this.attachShadow({mode:"open"})}adoptStyles(){const t=this.constructor._styles;0!==t.length&&(void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow?G?this.renderRoot.adoptedStyleSheets=t.map(t=>t.styleSheet):this._needsShimAdoptedStyleSheets=!0:window.ShadyCSS.ScopingShim.prepareAdoptedCssText(t.map(t=>t.cssText),this.localName))}connectedCallback(){super.connectedCallback(),this.hasUpdated&&void 0!==window.ShadyCSS&&window.ShadyCSS.styleElement(this)}update(t){const e=this.render();super.update(t),e!==tt&&this.constructor.render(e,this.renderRoot,{scopeName:this.localName,eventContext:this}),this._needsShimAdoptedStyleSheets&&(this._needsShimAdoptedStyleSheets=!1,this.constructor._styles.forEach(t=>{const e=document.createElement("style");e.textContent=t.cssText,this.renderRoot.appendChild(e)}))}render(){return tt}}et.finalized=!0,et.render=(t,e,i)=>{if(!i||"object"!=typeof i||!i.scopeName)throw new Error("The `scopeName` option is required.");const r=i.scopeName,n=$.has(e),o=R&&11===e.nodeType&&!!e.host,a=o&&!W.has(r),h=a?document.createDocumentFragment():e;if(((t,e,i)=>{let r=$.get(e);void 0===r&&(s(e,e.firstChild),$.set(e,r=new N(Object.assign({templateFactory:O},i))),r.appendInto(e)),r.setValue(t),r.commit()})(t,h,Object.assign({templateFactory:H(r)},i)),a){const t=$.get(h);$.delete(h);const i=t.value instanceof f?t.value.template:void 0;X(r,h,i),s(e,e.firstChild),e.appendChild(h),$.set(e,t)}!n&&o&&window.ShadyCSS.styleElement(e.host)};const st=(t,e,s={})=>{t.dispatchEvent(new CustomEvent(e,{detail:s}))};let it=class extends et{constructor(){super(...arguments),this._dragging=!1}firstUpdated(){this.addEventListener("mousedown",this._dragStart.bind(this)),document.addEventListener("mousemove",this._drag.bind(this)),document.addEventListener("mouseup",this._dragEnd.bind(this))}render(){return Y`<slot></slot>`}_dragStart(t){const e=this._getPos(t);this.startX=e.x,this.startY=e.y,this._dragging=!0,st(this,"dragStart",{startX:this.startX,startY:this.startY})}_drag(t){if(!this._dragging)return;t.stopPropagation();const e=this._getPos(t);let s=e.x-this.startX,i=e.y-this.startY;this.grid&&(s=Math.round(s/this.grid[0])*this.grid[0],i=Math.round(i/this.grid[1])*this.grid[1]),(s||i)&&st(this,"drag",{deltaX:s,deltaY:i})}_dragEnd(){this._dragging=!1,st(this,"dragEnd")}_getPos(t){return{x:t.type.startsWith("touch")?t.touches[0].clientX:t.clientX,y:t.type.startsWith("touch")?t.touches[0].clientY:t.clientY}}};t([J({type:Array})],it.prototype,"grid",void 0),it=t([I("lit-draggable")],it);let rt=class extends et{render(){return Y`
    ...
    `}};t([J({type:Array})],rt.prototype,"grid",void 0),rt=t([I("lit-draggable-wrapper")],rt);const nt=t=>{let e=0;for(const s of t){const t=s.posY+s.height;e=t>e?t:e}return e},ot=(t,e)=>t.key!==e.key&&(!(t.posX+t.width<=e.posX)&&(!(t.posX>=e.posX+e.width)&&(!(t.posY+t.height<=e.posY)&&!(t.posY>=e.posY+e.height)))),at=(t,e)=>{for(const s of t)if(ot(s,e))return s},ht=(t,e,s)=>{e.posY+=1;for(let i=t.map(t=>t.key).indexOf(e.key)+1;i<t.length;i++){const r=t[i];if(r.posY>e.posY+e.height)break;ot(e,r)&&ht(t,r,s+e.height)}e.posY=s};let lt=class extends et{render(){return Y`
      <slot></slot>
    ...
    `}};t([J({type:Number})],dt.prototype,"width",void 0),t([J({type:Number})],dt.prototype,"height",void 0),t([J({type:Number})],dt.prototype,"posX",void 0),t([J({type:Number})],dt.prototype,"posY",void 0),t([J({type:Number})],dt.prototype,"rowHeight",void 0),t([J({type:Number})],dt.prototype,"columns",void 0),t([J({type:Number})],dt.prototype,"parentWidth",void 0),t([J({type:Array})],dt.prototype,"margin",void 0),t([J({type:Number})],dt.prototype,"minWidth",void 0),t([J({type:Number})],dt.prototype,"minHeight",void 0),t([J()],dt.prototype,"key",void 0),dt=t([I("lit-grid-item")],dt);let pt=class extends et{constructor(){super(...arguments),this.layout=[],this.items=[],this.rowHeight=30,this.cols=12,this.margin=[10,10],this._currentLayout=[]}get childrenElements(){return this.items.concat(...Array.prototype.filter.call(this.children,t=>t.classList.contains("lit-grid-item")))}get layoutHeight(){const t=nt(this.layout);return t*this.rowHeight+(t-1)*this.margin[1]}updated(t){super.updated(t),t.has("layout")&&(this.setupLayout(),this.style.height=this.layoutHeight+"px")}render(){var t;return(null===(t=this._currentLayout)||void 0===t?void 0:t.length)?Y`
      ${this.childrenElements.map((t,e)=>{const s=this._currentLayout[e];return Y`
          <lit-grid-item
            .width=${s.width}
            .height=${s.height}
            .posY=${s.posY}
        ...
        `})}
    `:Y``}setupLayout(){let t=[];for(const e of this.childrenElements){let s=this.layout.find(t=>t.key===e.key);if(!s){const i=e.grid||{width:1,height:1,posX:0,posY:nt(t)};s=Object.assign(Object.assign({},i),{key:e.key})}t.push(s)}t=((t,e)=>{for(const s of t)s.posX+s.width>e&&(s.posX=e-s.width),s.posX<0&&(s.posX=0);return t})(t,this.cols),this._currentLayout=(t=>{const e=[],s=[],i=function(t){return t.slice(0).sort((function(t,e){return t.posY>e.posY||t.posY===e.posY&&t.posX>e.posX?1:t.posY===e.posY&&t.posX===e.posX?0:-1}))}(t);for(const r of i){for(;r.posY>0&&!at(e,r);)r.posY--;let n;for(;n=at(e,r);)ht(i,r,n.posY+n.height);e.push(r),s[t.indexOf(r)]=r}return s})(t)}_itemResize(t){const{newWidth:e,newHeight:s}=t.detail,i=t.currentTarget.key,r=this._currentLayout.findIndex(t=>t.key===i),n=this._currentLayout[r];this._currentLayout[r]=Object.assign(Object.assign({},n),{width:e,height:s}),this.layout=this._currentLayout}static get styles(){return Z`
      :host {
        display: block;
        position: relative;
      }
