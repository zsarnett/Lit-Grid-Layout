 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const b=t=>null===t||!("object"==typeof t||"function"==typeof t),w=t=>Array.isArray(t)||!(!t||!t[Symbol.iterator]);class x{constructor(t,e,s){this.dirty=!0,this.element=t,this.name=e,this.strings=s,this.parts=[];for(let t=0;t<s.length-1;t++)this.parts[t]=this._createPart()}_createPart(){return new P(this)}_getValue(){const t=this.strings,e=t.length-1;let s="";for(let i=0;i<e;i++){s+=t[i];const e=this.parts[i];if(void 0!==e){const t=e.value;if(b(t)||!w(t))s+="string"==typeof t?t:String(t);else for(const e of t)s+="string"==typeof e?e:String(e)}}return s+=t[e],s}commit(){this.dirty&&(this.dirty=!1,this.element.setAttribute(this.name,this._getValue()))}}class P{constructor(t){this.value=void 0,this.committer=t}setValue(t){t===y||b(t)&&t===this.value||(this.value=t,m(t)||(this.committer.dirty=!0))}commit(){for(;m(this.value);){const t=this.value;this.value=y,t(this)}this.value!==y&&this.committer.commit()}}class E{constructor(t){this.value=void 0,this.__pendingValue=void 0,this.options=t}appendInto(t){this.startNode=t.appendChild(d()),this.endNode=t.appendChild(d())}insertAfterNode(t){this.startNode=t,this.endNode=t.nextSibling}appendIntoPart(t){t.__insert(this.startNode=d()),t.__insert(this.endNode=d())}insertAfterPart(t){t.__insert(this.startNode=d()),this.endNode=t.endNode,t.endNode=this.startNode}setValue(t){this.__pendingValue=t}commit(){if(null===this.startNode.parentNode)return;for(;m(this.__pendingValue);){const t=this.__pendingValue;this.__pendingValue=y,t(this)}const t=this.__pendingValue;t!==y&&(b(t)?t!==this.value&&this.__commitText(t):t instanceof S?this.__commitTemplateResult(t):t instanceof Node?this.__commitNode(t):w(t)?this.__commitIterable(t):t===_?(this.value=_,this.clear()):this.__commitText(t))}__insert(t){this.endNode.parentNode.insertBefore(t,this.endNode)}__commitNode(t){this.value!==t&&(this.clear(),this.__insert(t),this.value=t)}__commitText(t){const e=this.startNode.nextSibling,s="string"==typeof(t=null==t?"":t)?t:String(t);e===this.endNode.previousSibling&&3===e.nodeType?e.data=s:this.__commitNode(document.createTextNode(s)),this.value=t}__commitTemplateResult(t){const e=this.options.templateFactory(t);if(this.value instanceof f&&this.value.template===e)this.value.update(t.values);else{const s=new f(e,t.processor,this.options),i=s._clone();s.update(t.values),this.__commitNode(i),this.value=s}}__commitIterable(t){Array.isArray(this.value)||(this.value=[],this.clear());const e=this.value;let s,i=0;for(const r of t)s=e[i],void 0===s&&(s=new E(this.options),e.push(s),0===i?s.appendIntoPart(this):s.insertAfterPart(e[i-1])),s.setValue(r),s.commit(),i++;i<e.length&&(e.length=i,this.clear(s&&s.endNode))}clear(t=this.startNode){s(this.startNode.parentNode,t.nextSibling,this.endNode)}}class N{constructor(t,e,s){if(this.value=void 0,this.__pendingValue=void 0,2!==s.length||""!==s[0]||""!==s[1])throw new Error("Boolean attributes can only contain a single expression");this.element=t,this.name=e,this.strings=s}setValue(t){this.__pendingValue=t}commit(){for(;m(this.__pendingValue);){const t=this.__pendingValue;this.__pendingValue=y,t(this)}if(this.__pendingValue===y)return;const t=!!this.__pendingValue;this.value!==t&&(t?this.element.setAttribute(this.name,""):this.element.removeAttribute(this.name),this.value=t),this.__pendingValue=y}}class C extends x{constructor(t,e,s){super(t,e,s),this.single=2===s.length&&""===s[0]&&""===s[1]}_createPart(){return new z(this)}_getValue(){return this.single?this.parts[0].value:super._getValue()}commit(){this.dirty&&(this.dirty=!1,this.element[this.name]=this._getValue())}}class z extends P{}let k=!1;(()=>{try{const t={get capture(){return k=!0,!1}};window.addEventListener("test",t,t),window.removeEventListener("test",t,t)}catch(t){}})();class ${constructor(t,e,s){this.value=void 0,this.__pendingValue=void 0,this.element=t,this.eventName=e,this.eventContext=s,this.__boundHandleEvent=t=>this.handleEvent(t)}setValue(t){this.__pendingValue=t}commit(){for(;m(this.__pendingValue);){const t=this.__pendingValue;this.__pendingValue=y,t(this)}if(this.__pendingValue===y)return;const t=this.__pendingValue,e=this.value,s=null==t||null!=e&&(t.capture!==e.capture||t.once!==e.once||t.passive!==e.passive),i=null!=t&&(null==e||s);s&&this.element.removeEventListener(this.eventName,this.__boundHandleEvent,this.__options),i&&(this.__options=T(t),this.element.addEventListener(this.eventName,this.__boundHandleEvent,this.__options)),this.value=t,this.__pendingValue=y}handleEvent(t){"function"==typeof this.value?this.value.call(this.eventContext||this.element,t):this.value.handleEvent(t)}}const T=t=>t&&(k?{capture:t.capture,passive:t.passive,once:t.once}:t.capture)
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
class{handleAttributeExpressions(t,e,s,i){const r=e[0];if("."===r){return new C(t,e.slice(1),s).parts}if("@"===r)return[new $(t,e.slice(1),i.eventContext)];if("?"===r)return[new N(t,e.slice(1),s)];return new x(t,e,s).parts}handleTextExpression(t){return new E(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */"undefined"!=typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.2.1");const R=(t,...e)=>new S(t,e,"html",L)
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
(window.litElementVersions||(window.litElementVersions=[])).push("2.3.1");const et={};class st extends q{static getStyles(){return this.styles}static _getUniqueStyles(){if(this.hasOwnProperty(JSCompiler_renameProperty("_styles",this)))return;const t=this.getStyles();if(void 0===t)this._styles=[];else if(Array.isArray(t)){const e=(t,s)=>t.reduceRight((t,s)=>Array.isArray(s)?e(s,t):(t.add(s),t),s),s=e(t,new Set),i=[];s.forEach(t=>i.unshift(t)),this._styles=i}else this._styles=[t]}initialize(){super.initialize(),this.constructor._getUniqueStyles(),this.renderRoot=this.createRenderRoot(),window.ShadowRoot&&this.renderRoot instanceof window.ShadowRoot&&this.adoptStyles()}createRenderRoot(){return this.attachShadow({mode:"open"})}adoptStyles(){const t=this.constructor._styles;0!==t.length&&(void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow?K?this.renderRoot.adoptedStyleSheets=t.map(t=>t.styleSheet):this._needsShimAdoptedStyleSheets=!0:window.ShadyCSS.ScopingShim.prepareAdoptedCssText(t.map(t=>t.cssText),this.localName))}connectedCallback(){super.connectedCallback(),this.hasUpdated&&void 0!==window.ShadyCSS&&window.ShadyCSS.styleElement(this)}update(t){const e=this.render();super.update(t),e!==et&&this.constructor.render(e,this.renderRoot,{scopeName:this.localName,eventContext:this}),this._needsShimAdoptedStyleSheets&&(this._needsShimAdoptedStyleSheets=!1,this.constructor._styles.forEach(t=>{const e=document.createElement("style");e.textContent=t.cssText,this.renderRoot.appendChild(e)}))}render(){return et}}st.finalized=!0,st.render=(t,e,i)=>{if(!i||"object"!=typeof i||!i.scopeName)throw new Error("The `scopeName` option is required.");const r=i.scopeName,n=H.has(e),o=O&&11===e.nodeType&&!!e.host,a=o&&!U.has(r),h=a?document.createDocumentFragment():e;if(((t,e,i)=>{let r=H.get(e);void 0===r&&(s(e,e.firstChild),H.set(e,r=new E(Object.assign({templateFactory:A},i))),r.appendInto(e)),r.setValue(t),r.commit()})(t,h,Object.assign({templateFactory:V(r)},i)),a){const t=H.get(h);H.delete(h);const i=t.value instanceof f?t.value.template:void 0;W(r,h,i),s(e,e.firstChild),e.appendChild(h),H.set(e,t)}!n&&o&&window.ShadyCSS.styleElement(e.host)};const it=(t,e,s={})=>{t.dispatchEvent(new CustomEvent(e,{detail:s}))};let rt=class extends st{constructor(){super(...arguments),this.disabled=!1,this._dragging=!1}firstUpdated(){this.addEventListener("mousedown",this._dragStart.bind(this),{passive:!0}),this.addEventListener("touchstart",this._dragStart.bind(this),{passive:!0}),document.addEventListener("mousemove",this._drag.bind(this),{passive:!0}),document.addEventListener("touchmove",this._drag.bind(this),{passive:!0}),document.addEventListener("mouseup",this._dragEnd.bind(this),{passive:!0}),document.addEventListener("touchcancel",this._dragEnd.bind(this),{passive:!0}),document.addEventListener("touchend",this._dragEnd.bind(this),{passive:!0})}render(){return R`<slot></slot>`}_dragStart(t){if(t.type.startsWith("mouse")&&0!==t.button)return;if(t.stopPropagation(),this.disabled)return;const e=this._getPos(t);this.startX=e.x,this.startY=e.y,this._dragging=!0,it(this,"dragStart",{startX:this.startX,startY:this.startY})}_drag(t){if(t.stopPropagation(),!this._dragging||this.disabled)return;const e=this._getPos(t);let s=e.x-this.startX,i=e.y-this.startY;this.grid&&(s=Math.round(s/this.grid[0])*this.grid[0],i=Math.round(i/this.grid[1])*this.grid[1]),(s||i)&&it(this,"dragging",{deltaX:s,deltaY:i})}_dragEnd(t){t.stopPropagation(),this._dragging&&!this.disabled&&(this._dragging=!1,it(this,"dragEnd"))}_getPos(t){return{x:t.type.startsWith("touch")?t.touches[0].clientX:t.clientX,y:t.type.startsWith("touch")?t.touches[0].clientY:t.clientY}}};t([J({type:Array})],rt.prototype,"grid",void 0),t([J({type:Boolean,reflect:!0})],rt.prototype,"disabled",void 0),rt=t([I("lit-draggable")],rt);let nt=class extends st{render(){return R`
    ...
    `}};t([J({type:Array})],nt.prototype,"grid",void 0),nt=t([I("lit-draggable-wrapper")],nt);const ot=t=>{let e=0;for(const s of t){const t=s.posY+s.height;e=t>e?t:e}return e},at=(t,e)=>t.key!==e.key&&(!(t.posX+t.width<=e.posX)&&(!(t.posX>=e.posX+e.width)&&(!(t.posY+t.height<=e.posY)&&!(t.posY>=e.posY+e.height)))),ht=(t,e)=>{for(const s of t)if(at(s,e))return s},dt=(t,e,s)=>{e.posY+=1;for(let i=t.map(t=>t.key).indexOf(e.key)+1;i<t.length;i++){const r=t[i];if(r.posY>e.posY+e.height)break;at(e,r)&&dt(t,r,s+e.height)}e.posY=s};function lt(t){return t.slice(0).sort((function(t,e){return t.posY>e.posY||t.posY===e.posY&&t.posX>e.posX?1:t.posY===e.posY&&t.posX===e.posX?0:-1}))}const pt=t=>{const e=[],s=[],i=lt(t);for(const r of i){for(;r.posY>0&&!ht(e,r);)r.posY--;let n;for(;n=ht(e,r);)dt(i,r,n.posY+n.height);r.hasMoved=!1,e.push(r),s[t.indexOf(r)]=r}return s};function ct(t,e,s,i,r){if(r){r=!1;const n={posX:s.posX,posY:Math.max(s.height-e.posY,0),width:s.width,height:s.height,key:"-1"};if(!ht(t,n))return ut(t,s,void 0,n.posY,i,r)}return ut(t,s,void 0,s.posY+1,i,r)}function ut(t,e,s,i,r,n){if(e.posY===i&&e.posX===s)return t;const o=e.posY;void 0!==s&&(e.posX=s),void 0!==i&&(e.posY=i),e.hasMoved=!0;let a=lt(t);void 0!==i&&o>=i&&(a=a.reverse());const h=function(t,e){return t.filter(t=>at(t,e))}(a,e),d=t.findIndex(t=>t.key===e.key);t[d]=e;for(let s=0,i=h.length;s<i;s++){const i=h[s];i.hasMoved||(t=ct([...t],e,i,r,n))}return t}let gt=class extends st{constructor(){super(...arguments),this.disabled=!1}render(){return R`
      <slot></slot>
      ...
      ${this.disabled?"":R`
            ...
            >
              ${this.handle?R`${this.handle}`:""}
            </lit-draggable>
          `}
    `}_resizeStart(){this.startWidth=this.clientWidth,this.startHeight=this.clientHeight,it(this,"resizeStart")}_resize(t){if(t.stopPropagation(),void 0===this.startWidth||void 0===this.startHeight)return;const{deltaX:e,deltaY:s}=t.detail;if(0===s&&0===e)return;const i=this.startWidth+e,r=this.startHeight+s;it(this,"resize",{width:i,height:r,deltaX:e,deltaY:s})}_resizeEnd(){this.startWidth=void 0,this.startHeight=void 0,it(this,"resizeEnd")}static get styles(){return tt`
      :host {
        position: relative;
        display: block;
      }
    ...
    `}};t([J({attribute:!1})],gt.prototype,"handle",void 0),t([J({type:Boolean})],gt.prototype,"disabled",void 0),gt=t([I("lit-resizable")],gt);let mt=class extends st{constructor(){super(...arguments),this.minWidth=1,this.minHeight=1,this.isDraggable=!0,this.isResizable=!0,this._isDragging=!1,this._isResizing=!1}updated(){this._isDragging||(this.style.setProperty("--item-left",Math.round(this.posX*(this._getColumnWidth()+this.margin[0]))+"px"),this.style.setProperty("--item-top",Math.round(this.posY*(this.rowHeight+this.margin[1]))+"px"),this._isResizing||(this.style.setProperty("--item-width",this.width*this._getColumnWidth()+Math.max(0,this.width-1)*this.margin[0]+"px"),this.style.setProperty("--item-height",this.height*this.rowHeight+Math.max(0,this.height-1)*this.margin[1]+"px")))}render(){let t=R`<slot></slot>`;return this.isResizable&&(t=R`
      ...
      `),t}_resizeStart(){this.isDraggable=!1,this._isResizing=!0,it(this,"resizeStart")}_resize(t){if(!this._isResizing)return;let{width:e,height:s}=t.detail;const i=this._getColumnWidth()*this.minWidth,r=(this._getColumnWidth()+this.margin[0])*(this.columns-this.posX)-this.margin[0],n=this.rowHeight*this.minHeight;e=Math.max(i,e),e=Math.min(r,e),s=Math.max(n,s),this.style.setProperty("--item-width",e+"px"),this.style.setProperty("--item-height",s+"px");const o=Math.round((e+this.margin[0])/(this._getColumnWidth()+this.margin[0])),a=Math.round((s+this.margin[1])/(this.rowHeight+this.margin[1]));o===this.width&&a===this.height||it(this,"resize",{newWidth:o,newHeight:a})}_resizeEnd(){this.isDraggable=!0,this._isResizing=!1,it(this,"resizeEnd")}_dragStart(){const t=this.getBoundingClientRect(),e=this.offsetParent.getBoundingClientRect();this._startLeft=t.left-e.left,this._startTop=t.top-e.top,this._startPosX=this.posX,this._startPosY=this.posY,this._isDragging=!0,it(this,"dragStart")}_drag(t){if(t.stopPropagation(),void 0===this._startPosX||void 0===this._startPosY||void 0===this._startLeft||void 0===this._startTop)return;const{deltaX:e,deltaY:s}=t.detail;this.style.setProperty("--item-left",this._startLeft+e+"px"),this.style.setProperty("--item-top",this._startTop+s+"px");const i=Math.round(e/(this._getColumnWidth()+this.margin[0])),r=Math.round(s/(this.rowHeight+this.margin[1]));if(!r&&!i)return;let n=this._startPosX+i,o=this._startPosY+r;n=Math.max(0,n),o=Math.max(0,o),n=Math.min(this.columns-this.width,n),it(this,"dragging",{newPosX:n,newPosY:o})}_dragEnd(){this._isDragging=!1,this._startLeft=void 0,this._startTop=void 0,this._startPosX=void 0,this._startPosY=void 0,it(this,"dragEnd")}_getColumnWidth(){return(this.parentWidth-this.margin[0]*(this.columns-1))/this.columns}static get styles(){return tt`
      :host {
        position: absolute;
    ...
    `}};t([J({type:Number})],mt.prototype,"width",void 0),t([J({type:Number})],mt.prototype,"height",void 0),t([J({type:Number})],mt.prototype,"posX",void 0),t([J({type:Number})],mt.prototype,"posY",void 0),t([J({type:Number})],mt.prototype,"rowHeight",void 0),t([J({type:Number})],mt.prototype,"columns",void 0),t([J({type:Number})],mt.prototype,"parentWidth",void 0),t([J({type:Array})],mt.prototype,"margin",void 0),t([J({type:Number})],mt.prototype,"minWidth",void 0),t([J({type:Number})],mt.prototype,"minHeight",void 0),t([J({type:Boolean})],mt.prototype,"isDraggable",void 0),t([J({type:Boolean})],mt.prototype,"isResizable",void 0),t([J({attribute:!1})],mt.prototype,"resizeHandle",void 0),t([J()],mt.prototype,"key",void 0),t([J({attribute:"dragging",reflect:!0,type:Boolean})],mt.prototype,"_isDragging",void 0),t([J({attribute:"resizing",reflect:!0,type:Boolean})],mt.prototype,"_isResizing",void 0),mt=t([I("lit-grid-item")],mt);let yt=class extends st{constructor(){super(...arguments),this.layout=[],this.elements=[],this.rowHeight=30,this.columns=12,this.margin=[10,10],this._currentLayout=[]}get childrenElements(){return this.elements.concat(...Array.prototype.filter.call(this.children,t=>t.classList.contains("lit-grid-item")))}get layoutHeight(){const t=ot(this.layout);return t*this.rowHeight+(t-1)*this.margin[1]}shouldUpdate(t){return!t.has("layout")||JSON.stringify(this.layout)!==JSON.stringify(this._currentLayout)}updated(t){if(super.updated(t),t.has("resizeHandle")&&!this.resizeHandle||!this.resizeHandle){const t=document.createElement("div");t.classList.add("default-handle"),this.resizeHandle=t}t.has("layout")&&this.setupLayout(),this.style.height=this.layoutHeight+"px"}render(){var t;return(null===(t=this._currentLayout)||void 0===t?void 0:t.length)&&this.resizeHandle?R`
      ${this.childrenElements.map((t,e)=>{const s=this._currentLayout[e],i=this.resizeHandle.cloneNode(!0);return R`
          <lit-grid-item
            .width=${s.width}
            .height=${s.height}
            .posY=${s.posY}
    ...
    `}};t([J({type:Array})],yt.prototype,"layout",void 0),t([J({type:Array})],yt.prototype,"elements",void 0),t([J({type:Number})],yt.prototype,"rowHeight",void 0),t([J({type:Number})],yt.prototype,"columns",void 0),t([J({type:Array})],yt.prototype,"margin",void 0),t([J({attribute:!1})],yt.prototype,"resizeHandle",void 0),t([G()],yt.prototype,"_currentLayout",void 0),t([G()],yt.prototype,"_placeholder",void 0),yt=t([I("lit-grid-layout")],yt);