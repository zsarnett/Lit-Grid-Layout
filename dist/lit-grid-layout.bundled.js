 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */;function M(t){let e=$.get(t.type);void 0===e&&(e={stringsArray:new WeakMap,keyString:new Map},$.set(t.type,e));let s=e.stringsArray.get(t.strings);if(void 0!==s)return s;const r=t.strings.join(i);return s=e.keyString.get(r),void 0===s&&(s=new o(t,t.getTemplateElement()),e.keyString.set(r,s)),e.stringsArray.set(t.strings,s),s}const $=new Map,V=new WeakMap;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
class{handleAttributeExpressions(t,e,s,i){const r=e[0];if("."===r){return new E(t,e.slice(1),s).parts}if("@"===r)return[new A(t,e.slice(1),i.eventContext)];if("?"===r)return[new C(t,e.slice(1),s)];return new x(t,e,s).parts}handleTextExpression(t){return new N(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */"undefined"!=typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.2.1");const O=(t,...e)=>new S(t,e,"html",z)
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
(window.litElementVersions||(window.litElementVersions=[])).push("2.3.1");const et={};class st extends q{static getStyles(){return this.styles}static _getUniqueStyles(){if(this.hasOwnProperty(JSCompiler_renameProperty("_styles",this)))return;const t=this.getStyles();if(void 0===t)this._styles=[];else if(Array.isArray(t)){const e=(t,s)=>t.reduceRight((t,s)=>Array.isArray(s)?e(s,t):(t.add(s),t),s),s=e(t,new Set),i=[];s.forEach(t=>i.unshift(t)),this._styles=i}else this._styles=[t]}initialize(){super.initialize(),this.constructor._getUniqueStyles(),this.renderRoot=this.createRenderRoot(),window.ShadowRoot&&this.renderRoot instanceof window.ShadowRoot&&this.adoptStyles()}createRenderRoot(){return this.attachShadow({mode:"open"})}adoptStyles(){const t=this.constructor._styles;0!==t.length&&(void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow?K?this.renderRoot.adoptedStyleSheets=t.map(t=>t.styleSheet):this._needsShimAdoptedStyleSheets=!0:window.ShadyCSS.ScopingShim.prepareAdoptedCssText(t.map(t=>t.cssText),this.localName))}connectedCallback(){super.connectedCallback(),this.hasUpdated&&void 0!==window.ShadyCSS&&window.ShadyCSS.styleElement(this)}update(t){const e=this.render();super.update(t),e!==et&&this.constructor.render(e,this.renderRoot,{scopeName:this.localName,eventContext:this}),this._needsShimAdoptedStyleSheets&&(this._needsShimAdoptedStyleSheets=!1,this.constructor._styles.forEach(t=>{const e=document.createElement("style");e.textContent=t.cssText,this.renderRoot.appendChild(e)}))}render(){return et}}st.finalized=!0,st.render=(t,e,i)=>{if(!i||"object"!=typeof i||!i.scopeName)throw new Error("The `scopeName` option is required.");const r=i.scopeName,n=V.has(e),o=L&&11===e.nodeType&&!!e.host,a=o&&!H.has(r),h=a?document.createDocumentFragment():e;if(((t,e,i)=>{let r=V.get(e);void 0===r&&(s(e,e.firstChild),V.set(e,r=new N(Object.assign({templateFactory:M},i))),r.appendInto(e)),r.setValue(t),r.commit()})(t,h,Object.assign({templateFactory:U(r)},i)),a){const t=V.get(h);V.delete(h);const i=t.value instanceof f?t.value.template:void 0;W(r,h,i),s(e,e.firstChild),e.appendChild(h),V.set(e,t)}!n&&o&&window.ShadyCSS.styleElement(e.host)};const it=(t,e,s={})=>{t.dispatchEvent(new CustomEvent(e,{detail:s}))};let rt=class extends st{constructor(){super(...arguments),this.isDraggable=!0,this._dragging=!1}firstUpdated(){this.addEventListener("mousedown",this._dragStart.bind(this)),document.addEventListener("mousemove",this._drag.bind(this)),document.addEventListener("mouseup",this._dragEnd.bind(this))}render(){return O`<slot></slot>`}_dragStart(t){if(!this.isDraggable)return;const e=this._getPos(t);this.startX=e.x,this.startY=e.y,this._dragging=!0,it(this,"dragStart",{startX:this.startX,startY:this.startY})}_drag(t){if(!this._dragging||!this.isDraggable)return;t.stopPropagation();const e=this._getPos(t);let s=e.x-this.startX,i=e.y-this.startY;this.grid&&(s=Math.round(s/this.grid[0])*this.grid[0],i=Math.round(i/this.grid[1])*this.grid[1]),(s||i)&&it(this,"dragging",{deltaX:s,deltaY:i})}_dragEnd(){this._dragging=!1,it(this,"dragEnd")}_getPos(t){return{x:t.type.startsWith("touch")?t.touches[0].clientX:t.clientX,y:t.type.startsWith("touch")?t.touches[0].clientY:t.clientY}}};t([J({type:Array})],rt.prototype,"grid",void 0),t([J({type:Boolean,reflect:!0})],rt.prototype,"isDraggable",void 0),rt=t([I("lit-draggable")],rt);let nt=class extends st{render(){return O`
    ...
    `}};ct=t([I("lit-resizable")],ct);let ut=class extends st{constructor(){super(...arguments),this.minWidth=1,this.minHeight=1,this._isDraggable=!0,this._isDragging=!1}updated(){this._isDragging||(this.style.setProperty("--item-width",this.width*this._getColumnWidth()+Math.max(0,this.width-1)*this.margin[0]+"px"),this.style.setProperty("--item-height",this.height*this.rowHeight+Math.max(0,this.height-1)*this.margin[1]+"px"),this.style.setProperty("--item-left",Math.round(this.posX*(this._getColumnWidth()+this.margin[0]))+"px"),this.style.setProperty("--item-top",Math.round(this.posY*(this.rowHeight+this.margin[1]))+"px"))}render(){return O`
      <lit-draggable
    ...
    `}};function gt(t,e,s,i,r){if(r){r=!1;const n={posX:s.posX,posY:Math.max(s.height-e.posY,0),width:s.width,height:s.height,key:"-1"};if(!ht(t,n))return mt(t,s,void 0,n.posY,i,r)}return mt(t,s,void 0,s.posY+1,i,r)}function mt(t,e,s,i,r,n){if(e.posY===i&&e.posX===s)return t;const o=e.posY;void 0!==s&&(e.posX=s),void 0!==i&&(e.posY=i),e.hasMoved=!0;let a=dt(t);void 0!==i&&o>=i&&(a=a.reverse(),console.log("moving up"));const h=function(t,e){return t.filter(t=>at(t,e))}(a,e);console.log(h),console.log("Moving Item: ",e.key);const l=t.findIndex(t=>t.key===e.key);t[l]=e;for(let s=0,i=h.length;s<i;s++){const i=h[s];i.hasMoved||(t=gt([...t],e,i,r,n))}return t}t([J({type:Number})],ut.prototype,"width",void 0),t([J({type:Number})],ut.prototype,"height",void 0),t([J({type:Number})],ut.prototype,"posX",void 0),t([J({type:Number})],ut.prototype,"posY",void 0),t([J({type:Number})],ut.prototype,"rowHeight",void 0),t([J({type:Number})],ut.prototype,"columns",void 0),t([J({type:Number})],ut.prototype,"parentWidth",void 0),t([J({type:Array})],ut.prototype,"margin",void 0),t([J({type:Number})],ut.prototype,"minWidth",void 0),t([J({type:Number})],ut.prototype,"minHeight",void 0),t([J()],ut.prototype,"key",void 0),t([G()],ut.prototype,"_isDraggable",void 0),t([J({attribute:"dragging",reflect:!0,type:Boolean})],ut.prototype,"_isDragging",void 0),ut=t([I("lit-grid-item")],ut);let _t=class extends st{constructor(){super(...arguments),this.layout=[],this.items=[],this.rowHeight=30,this.columns=12,this.margin=[10,10],this._currentLayout=[]}get childrenElements(){return this.items.concat(...Array.prototype.filter.call(this.children,t=>t.classList.contains("lit-grid-item")))}get layoutHeight(){const t=ot(this.layout);return t*this.rowHeight+(t-1)*this.margin[1]}updated(t){super.updated(t),t.has("layout")&&(this.setupLayout(),this.style.height=this.layoutHeight+"px")}render(){var t;return(null===(t=this._currentLayout)||void 0===t?void 0:t.length)?O`
      ${this.childrenElements.map((t,e)=>{const s=this._currentLayout[e];return O`
          <lit-grid-item
            .width=${s.width}
            .height=${s.height}
            .posY=${s.posY}
        ...
        `})}
    `:O``}setupLayout(){let t=[];for(const e of this.childrenElements){let s=this.layout.find(t=>t.key===e.key);if(!s){const i=e.grid||{width:1,height:1,posX:0,posY:ot(t)};s=Object.assign(Object.assign({},i),{key:e.key})}t.push(s)}t=((t,e)=>{for(const s of t)s.posX+s.width>e&&(s.posX=e-s.width),s.posX<0&&(s.posX=0);return t})(t,this.columns),this._currentLayout=pt(t)}_itemResize(t){const{newWidth:e,newHeight:s}=t.detail,i=t.currentTarget.key,r=this._currentLayout.findIndex(t=>t.key===i),n=this._currentLayout[r];this._currentLayout[r]=Object.assign(Object.assign({},n),{width:e,height:s}),this._currentLayout=pt(this._currentLayout)}_itemDrag(t){t.stopPropagation();const{newPosX:e,newPosY:s}=t.detail,i=t.currentTarget.key,r=this._currentLayout.findIndex(t=>t.key===i),n=this._currentLayout[r],o=mt([...this._currentLayout],n,e,s,this.columns,!0);this._currentLayout=pt(o)}static get styles(){return tt`
      :host {
        display: block;
        position: relative;
      }
    `}};t([J({type:Array})],_t.prototype,"layout",void 0),t([J({type:Array})],_t.prototype,"items",void 0),t([G()],_t.prototype,"_currentLayout",void 0),_t=t([I("lit-grid-layout")],_t);