 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */;function O(t){let e=$.get(t.type);void 0===e&&(e={stringsArray:new WeakMap,keyString:new Map},$.set(t.type,e));let s=e.stringsArray.get(t.strings);if(void 0!==s)return s;const r=t.strings.join(i);return s=e.keyString.get(r),void 0===s&&(s=new o(t,t.getTemplateElement()),e.keyString.set(r,s)),e.stringsArray.set(t.strings,s),s}const $=new Map,U=new WeakMap;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
(window.litElementVersions||(window.litElementVersions=[])).push("2.3.1");const tt={};class et extends F{static getStyles(){return this.styles}static _getUniqueStyles(){if(this.hasOwnProperty(JSCompiler_renameProperty("_styles",this)))return;const t=this.getStyles();if(void 0===t)this._styles=[];else if(Array.isArray(t)){const e=(t,s)=>t.reduceRight((t,s)=>Array.isArray(s)?e(s,t):(t.add(s),t),s),s=e(t,new Set),i=[];s.forEach(t=>i.unshift(t)),this._styles=i}else this._styles=[t]}initialize(){super.initialize(),this.constructor._getUniqueStyles(),this.renderRoot=this.createRenderRoot(),window.ShadowRoot&&this.renderRoot instanceof window.ShadowRoot&&this.adoptStyles()}createRenderRoot(){return this.attachShadow({mode:"open"})}adoptStyles(){const t=this.constructor._styles;0!==t.length&&(void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow?G?this.renderRoot.adoptedStyleSheets=t.map(t=>t.styleSheet):this._needsShimAdoptedStyleSheets=!0:window.ShadyCSS.ScopingShim.prepareAdoptedCssText(t.map(t=>t.cssText),this.localName))}connectedCallback(){super.connectedCallback(),this.hasUpdated&&void 0!==window.ShadyCSS&&window.ShadyCSS.styleElement(this)}update(t){const e=this.render();super.update(t),e!==tt&&this.constructor.render(e,this.renderRoot,{scopeName:this.localName,eventContext:this}),this._needsShimAdoptedStyleSheets&&(this._needsShimAdoptedStyleSheets=!1,this.constructor._styles.forEach(t=>{const e=document.createElement("style");e.textContent=t.cssText,this.renderRoot.appendChild(e)}))}render(){return tt}}et.finalized=!0,et.render=(t,e,i)=>{if(!i||"object"!=typeof i||!i.scopeName)throw new Error("The `scopeName` option is required.");const r=i.scopeName,n=U.has(e),o=L&&11===e.nodeType&&!!e.host,a=o&&!W.has(r),h=a?document.createDocumentFragment():e;if(((t,e,i)=>{let r=U.get(e);void 0===r&&(s(e,e.firstChild),U.set(e,r=new N(Object.assign({templateFactory:O},i))),r.appendInto(e)),r.setValue(t),r.commit()})(t,h,Object.assign({templateFactory:Y(r)},i)),a){const t=U.get(h);U.delete(h);const i=t.value instanceof f?t.value.template:void 0;j(r,h,i),s(e,e.firstChild),e.appendChild(h),U.set(e,t)}!n&&o&&window.ShadyCSS.styleElement(e.host)};const st=(t,e,s={})=>{t.dispatchEvent(new CustomEvent(e,{detail:s}))};let it=class extends et{constructor(){super(...arguments),this._dragging=!1}firstUpdated(){this.addEventListener("mousedown",this._dragStart.bind(this)),document.addEventListener("mousemove",this._drag.bind(this)),document.addEventListener("mouseup",this._dragEnd.bind(this))}render(){return z`<slot></slot>`}_dragStart(t){const e=this._getPos(t);this.startX=e.x,this.startY=e.y,this._dragging=!0,st(this,"dragStart",{startX:this.startX,startY:this.startY})}_drag(t){if(!this._dragging)return;t.stopPropagation();const e=this._getPos(t);let s=e.x-this.startX,i=e.y-this.startY;this.grid&&(s=Math.round(s/this.grid[0])*this.grid[0],i=Math.round(i/this.grid[1])*this.grid[1]),(s||i)&&st(this,"drag",{deltaX:s,deltaY:i})}_dragEnd(){this._dragging=!1,st(this,"dragEnd")}_getPos(t){return{x:t.type.startsWith("touch")?t.touches[0].clientX:t.clientX,y:t.type.startsWith("touch")?t.touches[0].clientY:t.clientY}}};t([J({type:Array})],it.prototype,"grid",void 0),it=t([I("lit-draggable")],it);let rt=class extends et{render(){return z`
    ...
    `}};t([J({type:Array})],rt.prototype,"grid",void 0),rt=t([I("lit-draggable-wrapper")],rt);const nt=t=>{let e=0;for(const s of t){const t=s.posY+s.height;e=t>e?t:e}return e},ot=(t,e)=>t.key!==e.key&&(!(t.posX+t.width<=e.posX)&&(!(t.posX>=e.posX+e.width)&&(!(t.posY+t.height<=e.posY)&&!(t.posY>=e.posY+e.height)))),at=(t,e)=>{for(const s of t)if(ot(s,e))return s},ht=(t,e,s)=>{e.posY+=1;for(let i=t.map(t=>t.key).indexOf(e.key)+1;i<t.length;i++){const r=t[i];if(r.posY>e.posY+e.height)break;ot(e,r)&&ht(t,r,s+e.height)}e.posY=s};let lt=class extends et{render(){return z`
      <slot></slot>

      <lit-draggable @drag=${this._resize} @dragStart=${this._resizeStart}>
      </lit-draggable>
    `}_resizeStart(){this.startWidth=this.clientWidth,this.startHeight=this.clientHeight}_resize(t){t.stopPropagation();const{deltaX:e,deltaY:s}=t.detail,i=this.startWidth+e,r=this.startHeight+s;st(this,"resize",{width:i,height:r,deltaX:e,deltaY:s})}static get styles(){return Z`
      :host {
        position: relative;
        display: block;
      }
    ...
    `}};lt=t([I("lit-resizable")],lt);let dt=class extends et{updated(){this.style.setProperty("--item-width",this.width*this._getColumnWidth()+Math.max(0,this.width-1)*this.margin[0]+"px"),this.style.setProperty("--item-height",this.height*this.rowHeight+Math.max(0,this.height-1)*this.margin[1]+"px"),this.style.setProperty("--item-left",Math.round(this.posX*(this._getColumnWidth()+this.margin[0]))+"px"),this.style.setProperty("--item-top",Math.round(this.posY*(this.rowHeight+this.margin[1]))+"px")}render(){return z`
      <lit-resizable @resize=${this._resize}>
        <slot></slot>
      </lit-resizable>
    `}_resize(t){const{width:e,height:s}=t.detail,i=Math.round((e+this.margin[0])/(this._getColumnWidth()+this.margin[0])),r=Math.round((s+this.margin[1])/(this.rowHeight+this.margin[1])),n=i-this.width,o=r-this.height;(n||o)&&st(this,"resize",{newWidth:i,newHeight:r})}_getColumnWidth(){return(this.parentWidth-this.margin[0]*(this.columns-1))/this.columns}static get styles(){return Z`
      :host {
        display: block;
        position: absolute;
    ...
    `}};t([J({type:Number})],dt.prototype,"width",void 0),t([J({type:Number})],dt.prototype,"height",void 0),t([J({type:Number})],dt.prototype,"posX",void 0),t([J({type:Number})],dt.prototype,"posY",void 0),t([J({type:Number})],dt.prototype,"rowHeight",void 0),t([J({type:Number})],dt.prototype,"columns",void 0),t([J({type:Number})],dt.prototype,"parentWidth",void 0),t([J({type:Array})],dt.prototype,"margin",void 0),t([J()],dt.prototype,"key",void 0),dt=t([I("lit-grid-item")],dt);let pt=class extends et{constructor(){super(...arguments),this.layout=[],this.items=[],this.rowHeight=30,this.cols=12,this.margin=[10,10],this._currentLayout=[]}get childrenElements(){return this.items.concat(...Array.prototype.filter.call(this.children,t=>t.classList.contains("lit-grid-item")))}get layoutHeight(){const t=nt(this.layout);return t*this.rowHeight+(t-1)*this.margin[1]}updated(t){super.updated(t),t.has("layout")&&(this.setupLayout(),this.style.height=this.layoutHeight+"px")}render(){var t;return(null===(t=this._currentLayout)||void 0===t?void 0:t.length)?z`
      ${this.childrenElements.map((t,e)=>{const s=this._currentLayout[e];return z`
          <lit-grid-item
            .width=${s.width}
            .height=${s.height}
            .posY=${s.posY}
        ...
        `})}
    `:z``}setupLayout(){let t=[];for(const e of this.childrenElements){let s=this.layout.find(t=>t.key===e.key);if(!s){const i=e.grid||{width:1,height:1,posX:0,posY:nt(t)};s=Object.assign(Object.assign({},i),{key:e.key})}t.push(s)}t=((t,e)=>{for(const s of t)s.posX+s.width>e&&(s.posX=e-s.width),s.posX<0&&(s.posX=0);return t})(t,this.cols),this._currentLayout=(t=>{const e=[];for(const s of t){for(;s.posY>0&&!at(e,s);)s.posY--;let i;for(;i=at(e,s);)ht(t,s,i.posY+i.height);e.push(s)}return e})(t)}_itemResize(t){const{newWidth:e,newHeight:s}=t.detail,i=t.currentTarget.key,r=this._currentLayout.findIndex(t=>t.key===i),n=this._currentLayout[r];this._currentLayout[r]=Object.assign(Object.assign({},n),{width:e,height:s}),this.layout=this._currentLayout}static get styles(){return Z`
      :host {
        display: block;
        position: relative;
      }
    `}};var ct;t([J({type:Array})],pt.prototype,"layout",void 0),t([J({type:Array})],pt.prototype,"items",void 0),t([J({attribute:!1,hasChanged:null==ct?void 0:ct.hasChanged})],pt.prototype,"_currentLayout",void 0),pt=t([I("lit-grid-layout")],pt);